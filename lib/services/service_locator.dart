...
import 'package:demo_app/repository/auth_repo/auth_repository_impl.dart';
import 'package:demo_app/repository/cart_repo.dart';
import 'package:demo_app/repository/order_repo/order_repository.dart';
import 'package:demo_app/repository/order_repo/order_repository_impl.dart';
import 'package:demo_app/repository/products_repo/products_repository.dart';
import 'package:demo_app/repository/products_repo/products_repository_impl.dart';
...
import 'package:demo_app/screens/forgot/components/bloc/forgot_bloc.dart';
...
import 'package:demo_app/screens/signup/components/bloc/signup_bloc.dart';
import 'package:demo_app/screens/splash/components/bloc/splash_bloc.dart';
...
Future<void> setupServiceLocator() async {
  ...
  // Register OrderRepository with the new implementation
  sl.registerLazySingleton<OrderRepository>(
    () => OrderRepositoryImpl(dio: sl(), prefs: sharedPreferences),
  );
  ...
  sl.registerFactory<OrderBloc>(
    () => OrderBloc(
      prefs: sl<SharedPrefService>(),
      orderRepository: sl<OrderRepository>(),
    ),
  );

  // Register OrderHistoryBloc with the new OrderRepository implementation
